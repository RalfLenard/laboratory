...
<head>
    <meta charset="UTF-8">
    <title>Fasting Blood Sugar Result</title>
    <style>
        body {
...
<body>
    ...
    <table class="analysis-table ml-100 mt-15 mb-15" style="width: 100%;">
        ...
        <tr>
            ...
            <td class="pad-right" style="color: {{ (is_numeric($chemistry->fasting) && $chemistry->fasting > 100) ? 'red' : 'black' }};">
                {{ $chemistry->fasting ?? ' ' }}
            </td>

            <td class="pad-left"><b>0 - 100 mg/dl</b></td>
        </tr>
